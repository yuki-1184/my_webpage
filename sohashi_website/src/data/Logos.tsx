...
export default function getProgrammingLanguageSvg(
  programmingLanguage: string,
  w: string,
  h: string
) {
  if (programmingLanguage === "Python")
    return <PythonLogo width={w} height={h} />;
  if (programmingLanguage === "JavaScript")
    return <JavaScriptLogo width={w} height={h} />;
  if (programmingLanguage === "TypeScript")
    return <TypeScriptLogo width={w} height={h} />;
  ...
  if (programmingLanguage === "React")
    return <ReactLogo width={w} height={h} />;
  if (programmingLanguage === "Scikit-Learn")
    return <ScikitLearnLogo width={w} height={h} />;
  if (programmingLanguage === "TensorFlow")
    return <TensorFlowLogo width={w} height={h} />;
  if (programmingLanguage === "Vue") return <VueLogo width={w} height={h} />;
  if (programmingLanguage === "Flask")
    return <FlaskLogo width={w} height={h} />;
}
